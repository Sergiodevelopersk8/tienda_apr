...
cerrarconexion();
header('location:formcategorias.php?alert=4&categoriavieja='.$categoriavieja.'&categorianueva='.$categorianueva);
}
else{
  
    header('location:formcategorias.php?alert=3&categoria='.$categorianueva);
}
}
else if($_POST['categoria'] ==""){

    header('location:formcategorias.php?alert=5');
